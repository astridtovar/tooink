        ...
        <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li> <a href="<?= ADMINISTRADOR_CONSULTA['url'] ?>" class="waves-effect active"><i class="fa fa-search"></i> <span class="hide-menu"> Consultar Usuario</span></a>
                        </li>
            ...
            <div id="page-wrapper">
                ...
                <div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    Lo sentimos, no fue posible activar la cuenta.
                </div>';
                    }
                }
                ?>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Consultar Usuarios</h4> </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                <h3 class="box-title m-b-0">Usuarios registrados</h3>
                                <br>
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <?php
                                                foreach ($listaUsuarios as $consulta) {
                                                    ?>
                                                    <td><?php echo $consulta->nombre_rol; ?></td>
                                                    <td><?php echo $consulta->numero_doc; ?></td>
                                                    <td><?php echo $consulta->nombre; ?></td>
                                                    <td><?php echo $consulta->apellido; ?></td>
                                                    <td><?php echo $consulta->correo; ?></td>
                                                    <td><?php echo $consulta->descripcion_estado; ?></td>
                                                    <td><?php if ($consulta->descripcion_estado != 'Activo') { ?>
                                                            <a href="<?= ADMINISTRADOR_ACTIVAR['url'] ?>?correo=<?= $consulta->correo; ?>">
                ...
                <!-- /.container-fluid -->
                <footer class="footer text-center"> 2018 &copy; Todos los derechos reservados. </footer>
            </div>
            <!-- /#page-wrapper -->
        </div>
        <!-- /#wrapper -->
