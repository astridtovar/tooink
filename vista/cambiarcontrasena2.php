            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li> <a href="<?= CAMBIAR_CLAVE_MODAL['url'] ?>" class="waves-effect active"><i class="fa fa-edit"></i> <span class="hide-menu"> Cambiar Contraseña</span></a>
                        </li>
                </div>
            </div>
                                ...
                                <form action="<?= CAMBIAR_CLAVE['url'] ?>" method="POST" class="form-horizontal" role="form" onsubmit="validacion()">
                                    <center>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button id="btnCambiarClave" class="btn btn-principal" type="submit" title="Guardar">Guardar</button>
                                        </div>
                                    </center>
                                </form>
                            </div>
